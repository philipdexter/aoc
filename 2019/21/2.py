...
command = ''
# must have 4 in front
command += '''\
OR D J
'''
# can have 5 and 9 in front, or 8 in front, or 5 and 6 and 7 in front
command += '''\
OR F T
AND F T
OR I T
...
AND T J
'''
# the next 3 should have a hole or no need to jump
command += '''\
NOT A T
NOT T T
AND B T
...
RUN
'''
commands = [ord(c) for c in command]
command_index = 0
